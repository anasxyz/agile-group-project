...
<body>
  <div class="container">
    ...
    window.onload = function() {
      ...
      document.getElementById('option10').innerHTML = currencyType + "10";
      document.getElementById('option20').innerHTML = currencyType + "20";
      document.getElementById('option50').innerHTML = currencyType + "50";
      } 
    };
